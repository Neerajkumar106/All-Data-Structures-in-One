...
void deleteFromPositionMyList() {
    ...
    position = temp->link;                  // Neeraj Kumar       
...
void deleteFromPositionMyDoublyList() {
    ...
    position = temp->next;                  // Neeraj Kumar        
...
void insertAtBeginingMyCircularList(int element) {
    struct cnode *newP = malloc(sizeof(struct cnode));
    newP->data = element;
    newP->next = tail->next;                      // Neeraj Kumar       
    tail->next = newP;
    printf("Element inserted successfully!\n");
}
...
void enqueueMyListQueue() {
    ...
    newP->data = element;                                      // Neeraj Kumar      
    newP->link = NULL;
...
void insertMyArrayBST() {
    ...
    if(bst[rootArray] == 0) {                                            // Neeraj Kumar
